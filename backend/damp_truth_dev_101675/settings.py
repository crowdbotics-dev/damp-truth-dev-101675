"""
Django settings for damp_truth_dev_101675 project.
...
ROOT_URLCONF = 'damp_truth_dev_101675.urls'
...
WSGI_APPLICATION = 'damp_truth_dev_101675.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "damp_truth_dev_101675 API",
    "DESCRIPTION": "API documentation for damp_truth_dev_101675 App",
    "VERSION": "v1",
}
